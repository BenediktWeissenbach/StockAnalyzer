...
public class YahooFinance {
    ...
    public String requestData(List<String> tickers) throws yahooApiException{
        ...
        try {
            ...
            e.printStackTrace();
            throw new yahooApiException("Please check the provided URL!" + e.getMessage());
        }
        ...
        try {
            ...
            throw new yahooApiException("Please check your internet connection!" + e.getMessage());
        }
    ...
    public YahooResponse getCurrentData(List<String> tickers) throws yahooApiException {
        ...
        try {
            ...
            throw new yahooApiException("When accessing the current Data an error has occured!" + e.getMessage());
        }
        return result;
    }
}